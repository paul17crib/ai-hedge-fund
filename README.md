...
> **Personal note:** I'm using this project to study how different investing philosophies translate into algorithmic decision-making. My main interest is comparing the value-oriented agents (Graham, Munger, Buffett) against the growth-oriented ones (Wood, Fisher) across different market conditions.
